...
import com.king.miaosha.CacheLockException;
import com.king.miaosha.RedisLock;
...
/**
 * Created by ljq on 2019/6/24 16:07
 */
public class CacheLockInterceptor implements InvocationHandler {
    ...
    /**
     * 从方法参数中找出@LockedComplexObject的参数，在redis中取该参数对应的锁
     * @param annotations
     * @param args
     * @return
